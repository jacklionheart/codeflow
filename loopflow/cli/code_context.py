...
from loopflow.io.token_profiler import profile_code_context, generate_flamegraph
import click
import logging
import tempfile
import platform
...
logger = logging.getLogger("loopflow.cli.code_context")
...
def cli(paths: str, pbcopy: bool, raw: bool, extension: Tuple[str, ...], profile: bool, flamegraph: bool) -> None:
    ...
    try:
        if profile or flamegraph:
            ...
            logger.debug(f"Profile complete")
            ...
            if flamegraph:
                ...
                temp_file = tempfile.NamedTemporaryFile(
                    prefix=f"flamegraph_{project_name}_",
                    suffix=".html",
                    dir="/tmp",
                    delete=False
                )
